...
class TrackDragTest extends GdxTestBase {
  ...
  def addPlacesSegmentAndSetsRangeAndTrack(): Unit = {
    ...
    timeline.addOrThrow(t0, s, TrackDragTest.rng(0, 100))
  ...
  def tryAddAtOccupiedRangeDoesNotReplace(): Unit = {
    ...
    timeline.addOrThrow(t0, a, TrackDragTest.rng(0, 100))
  ...
  def removeCollectionRemovesAll(): Unit = {
    ...
    val b: Segment = newSeg(100)
    timeline.addOrThrow(t0, a, TrackDragTest.rng(0, 100))
    timeline.addOrThrow(t0, b, TrackDragTest.rng(500, 600))
  ...
  def moveMultiSelectMovesAllMembersTogether(): Unit = {
    ...
    val b: Segment = newSeg(100)
    timeline.addOrThrow(t0, a, TrackDragTest.rng(0, 100))
    timeline.addOrThrow(t1, b, TrackDragTest.rng(500, 600))
  ...
  def moveTimeBackwardClampsAtZeroForLeadingMember(): Unit = {
    ...
    val a: Segment = newSeg(100)
    val b: Segment = newSeg(100)
    timeline.addOrThrow(t0, a, TrackDragTest.rng(50, 150))
    timeline.addOrThrow(t0, b, TrackDragTest.rng(200, 300))
  ...
  def moveIntoOccupiedSpotOnSameTrackDoesNotApply(): Unit = {
    ...
    timeline.addOrThrow(t0, mover, TrackDragTest.rng(0, 100))
    // 障碍占据 [100, 1100)，把 mover 挪到 [150,250) 会撞上它
    timeline.addOrThrow(t0, obstacle, TrackDragTest.rng(100, 1100))
  ...
  def moveTimeClampsAtObstacleEdge(): Unit = {
    ...
    timeline.addOrThrow(t0, mover, TrackDragTest.rng(0, 100))
    timeline.addOrThrow(t0, obstacle, TrackDragTest.rng(300, 400))
  ...
  def moveAcrossTrackIntoOccupiedSpotDoesNotApply(): Unit = {
    ...
    val obstacle: Segment = newSeg(1000)
    timeline.addOrThrow(t0, mover, TrackDragTest.rng(0, 100))
    timeline.addOrThrow(t1, obstacle, TrackDragTest.rng(0, 1000)) // 目标轨道同区间被占据
  ...
  def setEndSlidesBackKeepsStartFixed(): Unit = {
    val t0: Track = timeline.getTrack(0)
    val s: Segment = newSeg(100)
    timeline.addOrThrow(t0, s, TrackDragTest.rng(0, 50))
  ...
  def setStartIntoOccupiedSpotDoesNotApply(): Unit = {
    ...
    val s: Segment = newSeg(100)
    val obstacle: Segment = newSeg(100)
    timeline.addOrThrow(t0, obstacle, TrackDragTest.rng(0, 100)) // 左侧障碍占住 [0,100)
    timeline.addOrThrow(t0, s, TrackDragTest.rng(100, 200))      // 把 s 起点往左推到 50 会撞上它
  ...
  def setStartBackwardClampsToNearestObstacleEdge(): Unit = {
    ...
    timeline.addOrThrow(t0, s, TrackDragTest.rng(50, 100))      // 前端已被裁切，origin=0 → minStart=0
    timeline.addOrThrow(t0, obstacle, TrackDragTest.rng(0, 30)) // 占住 [0,30)
  ...
  def setEndForwardClampsToNearestObstacleEdge(): Unit = {
    ...
    timeline.addOrThrow(t0, s, TrackDragTest.rng(0, 50))
    timeline.addOrThrow(t0, obstacle, TrackDragTest.rng(80, 120)) // 占住 [80,120)
  ...
  def groupSetEndAdjacentMembersDoNotOverlap(): Unit = {
    ...
    b.setOrigin(600)
    timeline.addOrThrow(t0, a, TrackDragTest.rng(0, 100))
    timeline.addOrThrow(t0, b, TrackDragTest.rng(100, 200)) // 与 a 相邻
  ...
  def groupSetStartAdjacentMembersDoNotOverlap(): Unit = {
    ...
    val a: Segment = newSeg(100)
    val b: Segment = newSeg(100)
    timeline.addOrThrow(t0, a, TrackDragTest.rng(100, 200))
    timeline.addOrThrow(t0, b, TrackDragTest.rng(200, 300)) // 与 a 相邻
  ...
  def snapTimeSnapsToNearestEdgeWithinThreshold(): Unit = {
    ...
    val b: Segment = newSeg(100)
    timeline.addOrThrow(t0, a, TrackDragTest.rng(100, 200))
    timeline.addOrThrow(t0, b, TrackDragTest.rng(400, 500))
